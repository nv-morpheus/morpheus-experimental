...
def load_sflow(path="../dataset"):
    ...
    for raw_mac, mac_id in mac_dict.items():
        ...
        microsoft_app_device_armis = 1 if 'Microsoft' in app_device or 'Windows'\
            in app_device or 'Azure' in app_device or 'microsoft' in app_device else np.nan
        ...
        browser_app_device_armis = 1 if 'Chrome' in app_device \
            or 'Edge' in app_device or 'Browser' in app_device else np.nan
        db_app_device_armis = 1 if 'mongodb' in app_device \
            or 'cassandra' in app_device or 'Redis' in app_device else np.nan
        python_app_device_armis = 1 if 'python' in app_device else np.nan
        vmware_app_device_armis = 1 if 'VMware' in app_device \
            or 'Carbon Black' in app_device else np.nan

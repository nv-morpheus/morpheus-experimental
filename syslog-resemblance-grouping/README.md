...
### API Example
See this [notebook](https://github.com/nv-morpheus/morpheus-experimental/syslog-resemblance-grouping/training-tuning/syslog-resemblance-grouping.ipynb) for an example on building and inferencing a SRG model.
